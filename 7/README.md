# Домашнее задание к занятию 7 Архитектурные паттерны. MVP. MVVM. Координаторы
...
Первый вариант - может быть, есть смысл перевести приложение `Navigation` целиком на UI в коде, без `storyboard`. 
