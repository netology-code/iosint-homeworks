...
**В домашнем задании используйте в качестве за основу [демонстрационный проект из лекции](https://github.com/netology-code/iosint-code/blob/main/10/AVFoundation_Audio.zip) и дополните его возможностями, которые указаны ниже.**
